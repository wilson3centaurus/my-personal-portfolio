<div class="container py-8">
  ...
  <div class="card">
      <div class="left-side two-images">
          <img class="project-image two-image" src="../public/images/projects/project (3).png" alt="">
          <img class="project-image two-image" src="../public/images/projects/project (5).png" alt="">
      </div>
  ...
  <div class="card">
      ...
      <div class="right-side">
          ...
          <div class="project-buttons">
              <a href="https://wilson3centaurus.github.io/rock-paper-scissor/" class="view-button" target="_blank">
                  <img class=" bi bi-globe project-btn-icon" src="images/live.png" alt="" width="20" height="auto">
                  Live
              </a>
  ...
  <div class="card">
      ...
      <div class="right-side">
          ...
          <div class="project-buttons">
              <a href="https://wilson3centaurus.github.io/todo-list/" class="view-button" target="_blank">
                  <img class=" bi bi-globe project-btn-icon" src="images/live.png" alt="" width="20" height="auto">
                  Live
              </a>
  ...
  <div class="card">
      ...
      <div class="right-side">
          ...
          <div class="project-buttons">
              <a href="https://wilson3centaurus.github.io/solar-system/" class="view-button" target="_blank">
                  <img class=" bi bi-globe project-btn-icon" src="images/live.png" alt="" width="20" height="auto">
                  Live
              </a>
