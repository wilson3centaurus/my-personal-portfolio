      ...
      <div class="w-full lg:w-1/2 contact-details">
        <div class="text-left max-w-xl px-6">
          ...
          <ul class="font-general-regular">
            ...
            <li class="flex">
              <a href="mailto:tafadzwawilsonsedze@gmail.com" target="_blank" class="contact-icon bg-gray-100 text-gray-500 p-3 rounded-lg text-2xl hover:text-slate-800 icon" ><span class="bi bi-envelope-fill"></span></a>
              <span class="text-lg mb-4 text-ternary-dark dark:text-ternary-light">tafadzwawilsonsedze@gmail.com</span>
            </li>
            <li class="flex">
              <a href="tel:+263772668496" target="_blank" class="contact-icon bg-gray-100 text-gray-500 p-3 rounded-lg text-2xl hover:text-slate-800 icon" ><span class="bi bi-telephone-fill"></span></a>
              <span class="text-lg mb-4 text-ternary-dark dark:text-ternary-light">+263772668496 | +263787209882</span>
            </li>
            <li class="flex">
              <a href="https://github.com/wilson3centaurus" target="_blank" class="contact-icon bg-gray-100 text-gray-500 p-3 rounded-lg text-2xl hover:text-slate-800 icon" ><span class="bi bi-github"></span></a>
              <span class="text-lg mb-4 text-ternary-dark dark:text-ternary-light">https://github.com/wilson3centaurus</span>
            </li>
